...
export const unitSchema = yup.object().shape({
  nameUnit: yup
    .string()
    .min(5, "Deskripsi unit minimal 5 character")
  ...
  descUnit: yup
    .string()
    .min(10, "Deskripsi unit minimal 20 character")
    .required("harus diisi"),
  ...
  qtyUnit: yup
    .number()
    .required("harus diisi!")
    .min(0, "Ketersediaan Unit tidak boleh negatif"),
});
...
export const buySchema = yup.object().shape({
  ...
  receiverHp: yup
    ...
    .min(12, "nomor tidak valid")
    .max(13, "nomor tidak valid"),
...
export const rentSchema = yup.object().shape({
  ...
  receiverHp: yup
    ...
    .max(13, "nomor tidak valid"),
  receiverAddress: yup
  .string().required("alamat harus diisi!")
