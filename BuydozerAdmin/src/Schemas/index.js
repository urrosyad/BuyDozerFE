...
export const rentListSchema = yup.object().shape({
  nameRent: yup.string().min(3, 'Deskripsi unit minimal 3 character').required('Nama Sewa tidak boleh kosong!'),
  priceRentUnit: yup.number().required('Harga Sewa tidak boleh kosong!').min(0, 'Harga Sewa tidak boleh negatif atau 0!'),
  months: yup.number().required('Bulan Sewa tidak boleh kosong!').min(0, 'Bulan Sewa tidak boleh negatif atau 0!'),
})
